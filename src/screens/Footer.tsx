...
<Typography
    ...
    <Stack style={{flexDirection:'row',alignItems:'center', justifyContent:'space-between'}} sx={{mt:{xs:10, sm:2, md:1, lg:1, xl:1}, mx:{xs:3, sm:3, md:4, lg:10, xl:10,}}}>

            <CardMedia
            component="img"
            image={polygon}
            alt="Logo"
            sx={{width: {xs:80, sm:80, md:50, lg:80, xl:80}, objectFit:'cover',}}
            />          <CardMedia
            component="img"
            image={binance}
            alt="Logo"
            sx={{width: {xs:200, sm:200, md:200, lg:200, xl:200}, objectFit:'cover',}}
            />       <CardMedia
            component="img"
            image={cronos}
            alt="Logo"
            ...
            image={avalanche}
            alt="Logo"
            sx={{width: {xs:80, sm:80, md:80, lg:80, xl:80}, objectFit:'cover',}}
            />     
                <CardMedia
            component="img"
            image={ethereum}
            alt="Logo"
            sx={{width: {xs:70, sm:70, md:70, lg:70, xl:70}, objectFit:'cover',}}
            />   
